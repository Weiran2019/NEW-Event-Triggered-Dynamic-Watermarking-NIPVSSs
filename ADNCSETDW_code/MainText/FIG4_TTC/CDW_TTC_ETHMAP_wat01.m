...
Data_a = importdata('CDW_TTC_wat01_att.txt');
...
for i=2:len_a
    bR_a=bR_a+([res1_a(i)*res1_a(i),res1_a(i)*res2_a(i);res2_a(i)*res1_a(i),res2_a(i)*res2_a(i)]-Sigma_ro);
    bD_a=bD_a+wat_a(i-1)*[res1_a(i);res2_a(i)];
...
saveas(fig1,'CDW_TTC_ETHMAP_x1','pdf');
saveas(fig2,'CDW_TTC_ETHMAP_x2','pdf');
saveas(fig3,'CDW_TTC_ETHMAP_ga','pdf');
saveas(fig4,'CDW_TTC_ETHMAP_rr','pdf');
saveas(fig5,'CDW_TTC_ETHMAP_rd','pdf');
saveas(fig6,'CDW_TTC_ETHMAP_ap','pdf');