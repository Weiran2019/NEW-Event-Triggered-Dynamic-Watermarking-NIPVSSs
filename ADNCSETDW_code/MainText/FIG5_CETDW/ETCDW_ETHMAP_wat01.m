...
Data_a = importdata('TVKF_wat01_del00001_ETCDW_ETHMAP.txt');
...
for i=2:len_a
    ...
    bD_a=bD_a+(wat_a(i-1)*[res1_a(i);res2_a(i)]+(1-gamma_a(i))*C*B*0.0001);
...
saveas(fig1,'ETCDW01_ETHMAP_x1','pdf');
saveas(fig2,'ETCDW01_ETHMAP_x2','pdf');
saveas(fig3,'ETCDW01_ETHMAP_ga','pdf');
saveas(fig4,'ETCDW01_ETHMAP_rr','pdf');
saveas(fig5,'ETCDW01_ETHMAP_rd','pdf');
saveas(fig6,'ETCDW01_ETHMAP_ap','pdf');