...
Data_a = importdata('TVKF_wat0001_del00001_ETNDW_ETHMAP.txt');
...
set(le11,'Interpreter','latex');
set(le12,'Interpreter','latex');
t21=text(len_a-40,ang_a(len_a),'OFF');
...
saveas(fig1,'ETNDW0001_ETHMAP_x1','pdf');
saveas(fig2,'ETNDW0001_ETHMAP_x2','pdf');
saveas(fig3,'ETNDW0001_ETHMAP_ga','pdf');
saveas(fig4,'ETNDW0001_ETHMAP_rr','pdf');
saveas(fig5,'ETNDW0001_ETHMAP_rd','pdf');
saveas(fig6,'ETNDW0001_ETHMAP_ap','pdf');