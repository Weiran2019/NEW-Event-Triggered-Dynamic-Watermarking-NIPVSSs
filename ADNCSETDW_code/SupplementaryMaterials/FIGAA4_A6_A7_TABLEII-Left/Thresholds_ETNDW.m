...
%%第2组数据
Data = importdata('TVKF_del00001_ETNDW_nor2.txt');
len=length(Data.data(:,1));
len_vec(2)=len;
pos=Data.data(:,2);
ang=Data.data(:,3);
...
%%第3组数据
Data = importdata('TVKF_del00001_ETNDW_nor3.txt');
len=length(Data.data(:,1));
len_vec(3)=len;
pos=Data.data(:,2);
ang=Data.data(:,3);
...
%%第4组数据
Data = importdata('TVKF_del00001_ETNDW_nor4.txt');
len=length(Data.data(:,1));
len_vec(4)=len;
pos=Data.data(:,2);
ang=Data.data(:,3);
...
%%第5组数据
Data = importdata('TVKF_del00001_ETNDW_nor5.txt');
len=length(Data.data(:,1));
len_vec(5)=len;
pos=Data.data(:,2);
ang=Data.data(:,3);
...
%%第6组数据
Data = importdata('TVKF_del00001_ETNDW_nor6.txt');
len=length(Data.data(:,1));
len_vec(6)=len;
pos=Data.data(:,2);
ang=Data.data(:,3);
...
saveas(fig3,'Thd_rr_ETNDW','pdf');
saveas(fig4,'Thd_rd_ETNDW','pdf');
saveas(fig1,'ETNDW_nor4_x1','pdf');
saveas(fig2,'ETNDW_nor4_x2','pdf');
saveas(fig5,'ETNDW_nor4_ga','pdf');
